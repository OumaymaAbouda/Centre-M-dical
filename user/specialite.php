                        ...
                        <div class='row align-items-center'>
                            ...
                            <div class='col-lg-7'>
                                <div class='dept_info'>
                                    <h3>{$row['name']}</h3 >
                                    <p>{$row['description']} </p>
                                    <a href='#' class='boxed-btn'>Rendez-vous</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="single_emergency">
                            ...
                            <div class="info_button">
                                <a href="#" class="boxed-btn3-white">Rendez-vous
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="single_emergency align-items-center d-flex justify-content-end">
                            ...
                            <div class="info">
                                <span>Soins Médicaux D'urgence</span>
                                <h3>73223105</h3>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-12">
                    <select class='form-select wide' id='default-select' name="médecin">
                        ...
                        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                            echo "<option value='" . $row['nom'] . $row['prenom'] . "'>" . $row['nom'] . "&nbsp" . $row['prenom'] . "</option>";
                        }
                        ?>
                    </select>
                </div>
