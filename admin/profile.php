<?php
     include("config.php");
     $result = $connexion->prepare("SELECT * FROM admin");
     $result->execute();
...
<html lang="en">
  <head>
    ...
    <title>Centre Medical STEG | Profile</title>
            ...
            >
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="listSpecialite.html" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Consulter</p>
                    </a>
                  </li>
              ...
              <div class="col-8">
                ...
                <div class="card card-primary">
                  <div class="card-header">
                    <h3 class="card-title">
                      <i class="fa fa-pen"></i> Profile
                    </h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form method="post" enctype="multipart/form-data"  action="upAdmin.php">
                    <div class="card-body">
