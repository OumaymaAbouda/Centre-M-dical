...
<html lang="en">
  <head>
    ...
    <title>Centre Medical STEG | Spécialité</title>
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
            ...
            >
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="listMedecin.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Consulter</p>
                    </a>
                  </li>
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body table-responsive p-0">
                    <table id="listProd" class="table table-hover text-nowrap">
                      <thead>
                        <tr>
                          <th>ID</th>
                          <th>Nom</th>
    ...
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
      ...
      echo"<tr><td>" .$row["id"]. "</td><td>" .$row["nom"]. "</td> <td>".$row["prenom"]."</td><td>".$row["email"]."</td> <td>" .$row["specialite"]. "</td>
      <td><a href=\"modif_med.php?id=".$row["id"]."\">Modifier</a></td>"
      ."</td><td><a href=\"supp_med.php?id=".$row["id"]."\"onclick=\"return confirm('vous voulez vraiment supprimer cet specialite')\">Supprimer</a></td></tr>";
    }
