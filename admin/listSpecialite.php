...
<html lang="en">
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    ...
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
      ...
      "</td><td><a href=\"modif_sp.php?id=".$row["id"]."\">Modifier</a></td>"
      ."</td><td><a href=\"supp_sp.php?id=".$row["id"]."\"onclick=\"return confirm('vous voulez vraiment supprimer cet specialite')\">Supprimer</a></td></tr>";
    }
